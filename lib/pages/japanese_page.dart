...
class Japanese extends StatefulWidget {
  ...
  @override
  State<Japanese> createState() => _JapaneseState();
}
...
class _JapaneseState extends State<Japanese> {
  ...
  List<FilDish> dishes = [
    FilDish(
        ...
        image: 'assets/japancurry.jpg',
        pax: '3 to 5 pax',
        text: '25 Mins To Serve',
        price: '250.00'),
    FilDish(
        label: 'Udon',
        image: 'assets/japanudon.jpg',
        pax: '1 pax',
        text: '25 Mins To Serve',
        price: '200.00'),
    FilDish(
        label: 'Tempura',
        image: 'assets/japantempura.png',
        pax: '4 to 6 pax',
        text: '25 Mins To Serve',
        price: '450.00'),
    FilDish(
        label: 'Ramen',
        image: 'assets/japanramen.jpg',
        pax: '1 pax',
        text: '25 Mins To Serve',
        price: '200.00'),
    FilDish(
        label: 'Sushi',
        image: 'assets/japansushi.webp',
        pax: '2 to 3 pax',
        text: '25 Mins To Serve',
        price: '250.00'),
    FilDish(
